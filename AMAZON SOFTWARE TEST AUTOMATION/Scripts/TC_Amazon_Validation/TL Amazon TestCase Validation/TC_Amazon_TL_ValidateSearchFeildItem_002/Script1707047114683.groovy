...
//WebUI.click(findTestObject('TL_Amazon_TestCaseValidation_OR/Amazon_TL_ValidateSearchFeildItem_OR/span_Account  Lists'))
...
WebUI.selectOptionByLabel(findTestObject('TL_Amazon_TestCaseValidation_OR/Amazon_TL_ValidateSearchFeildItem_OR/CategoryElements'), 
    'Books', false)

WebUI.setText(findTestObject('TL_Amazon_TestCaseValidation_OR/Amazon_TL_ValidateSearchFeildItem_OR/input_Search Amazon_field-keywords'), 
    'Da vinci code')

WebUI.click(findTestObject('TL_Amazon_TestCaseValidation_OR/Amazon_TL_ValidateSearchFeildItem_OR/input_Search Amazon_nav-search-submit-button'))
